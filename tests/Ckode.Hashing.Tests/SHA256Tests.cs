...
namespace Ckode.Hashing.Tests
{
	public class SHA256Tests
	{
		...
		public void IsThisAlgorithm_InvalidInput_ReturnsFalse()
		{
			...
			// Act
			var isThisAlgorithm = algorithm.IsThisAlgorithm("not an SHA256 hash");
		...
		public void ValidateHash_NullInput_Throws()
		{
			...
			// Act && Assert
			Assert.Throws<ArgumentNullException>(() => algorithm.ValidateHash(null, "not an SHA256 hash"));
		...
		public void ValidateHash_InvalidCorrectHash_Throws()
		{
			...
			// Act && Assert
			Assert.Throws<ArgumentException>(() => algorithm.ValidateHash("Hello world", "not an SHA256 hash"));
		}
